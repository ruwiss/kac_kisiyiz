    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (context) => locator<AddSurveyViewModel>()),
        ChangeNotifierProvider(
            create: (context) => locator<SurveysViewModel>()),
        ChangeNotifierProvider(
            create: (context) => locator<CategoriesViewModel>()),
        ChangeNotifierProvider(
            create: (context) => locator<PaymentsViewModel>()),
      ],
