...
class Connector {
    ...
    createTables() {
        return __awaiter(this, void 0, void 0, function* () {
            const sql = "CREATE TABLE IF NOT EXISTS users (id INT PRIMARY KEY AUTO_INCREMENT, mail VARCHAR(255), password VARCHAR(255), name VARCHAR(255), money DECIMAL(10, 2) NOT NULL DEFAULT '0.00', onesignalId VARCHAR(255) DEFAULT '');" +
